...
let CampaignController = class CampaignController {
    ...
    async getCampaigns(dto) {
        ...
        if (dto.userId) {
            const foundCampaigns = await this.campaignService.findManyByUserId(dto.userId);
...
__decorate([
    ...
    __metadata("design:paramtypes", [campaign_dto_1.GetCampaignDto]),
